...
export async function sendNewsletter() {
    ...
    newsletterText =
    `Sunday Digest from the PolloPollo Platform.\n
    ...
    here are currently ${openApplications} open applications waiting for donors.
    ...
    for (const r of rows) {
        device.sendMessageToDevice(r.DeviceAddress, "text", newsletterText);
    }
